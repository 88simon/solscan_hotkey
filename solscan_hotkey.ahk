...
; Version: 2.1 (AutoHotkey v2)
;
; Recent changes:
; - URL-based exclusion persistence (per-tab, no global state)
; - Parses existing exclusions from browser URL
; - Supports multiple tabs with independent exclusion lists
; ============================================================================
